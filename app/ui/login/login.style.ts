...
export const LoginButton =
  "mt-[15px] w-full cursor-pointer rounded-[5px] border-0 bg-[var(--button-color-blue)] p-2.5 text-[var(--text-color)]";
export const LoginTitle = "mb-[15px]";
export const LoginInput =
  "mb-2.5 w-full rounded-[5px] border border-[var(--border-color)] bg-[var(--bg-color)] p-2.5 text-[var(--text-color)]";
